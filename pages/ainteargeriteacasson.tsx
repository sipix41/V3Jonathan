...
export const ainteargeriteacasson: React.FC = () => {
  ...
  return (
    <div className="w-full">
      <SEO
        ...
        canonicalUrl="/sainte-margerite-d-lac-masson"
      >
