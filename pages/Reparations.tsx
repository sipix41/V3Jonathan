          ...
          <div className="flex flex-col md:flex-row items-center gap-6 justify-center text-center">
            ...
            <div className="text-left">
              ...
              <p className="text-gray-400">
                Basés à <strong><Link to="/sainte-agathe-des-monts" className="text-brand-red font-bold hover:underline hover:scale-110 inline-block transition-transform">{COMPANY_INFO.address.split(',')[0]}</Link>{COMPANY_INFO.address.includes(',') ? `, ${COMPANY_INFO.address.split(',')[1]}` : ''}</strong>, nos couvreurs se déplacent rapidement à <Link to="/val-david" className="text-brand-red font-bold hover:underline hover:scale-110 inline-block transition-transform">Val-David</Link>, Mont-Blanc, <Link to="/mont-tremblant" className="text-brand-red font-bold hover:underline hover:scale-110 inline-block transition-transform">Mont-Tremblant</Link>, Piedmont, <Link to="/saint-sauveur" className="text-brand-red font-bold hover:underline hover:scale-110 inline-block transition-transform">Saint-Sauveur</Link> et partout dans les <Link to="/laurentides" className="text-brand-red font-bold hover:underline hover:scale-110 inline-block transition-transform">Laurentides</Link>.
              </p>
            </div>
          </div>
        </div>
