...
export const aintastinacarre: React.FC = () => {
  ...
  return (
    <div className="w-full">
      <SEO
        ...
        canonicalUrl="/saint-astin-lac-carré"
      >
