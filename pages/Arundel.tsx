            ...
            {[
              {
                ...
                desc: "Nous connaissons les réalités de Arundel, des grands corridors de vents des secteurs ruraux (Saint-Benoît, Sainte-Scholastique) aux densités urbaines (Domaine-Vert, Saint-Janvier). Nos méthodes de fixation sont fermement adaptées en conséquence.",
              },
              {
